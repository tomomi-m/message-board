<div name="stdHeader" data-role="header">
	<div class="table" style="width: 100%">
		<div class="row">
			...
			<div
				style="overflow: visible; white-space: normal; word-break: break-all; padding: 0em 0.5em 0em 0em;">
				{{{$page->title}}}</div>
			<div style="width: 1em; padding: 0px;">
@if ($isEditable) <?php ?>
				<a onclick="openHeaderMenu(event)" data-icon="gear"
					class="ui-btn-right" data-role="button" style="position: relative">MENU</a>
				@endif
				<div
					style="font-weight: normal; font-size: x-small; width: 8em; margin-top: 1em; word-wrap: break-word; min-height: 2em">
					<span name="logedInUserNameP" class="ui-icon-user ui-btn-icon-left"
						style="position: relative; margin-left: -0.5em"></span>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="pageUpdatedAt"
		style="position: absolute; right: 0; bottom: 0; font-weight: normal; z-index: 2">{{$page->updated_at?$page->updated_at->format('Y-m-d
		H:i').'更新':""}} {{$page->updated_by?('by '.$page->updated_by):''}}</div>
